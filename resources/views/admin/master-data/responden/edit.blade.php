...
@section('content')
    ...
    <div class="card">
        <form action="{{ route('responden.update', $responden->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" value="{{$responden->name}}" class="form-control @error('name') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="birth_date" value="{{$responden->birth_date}}" class="form-control @error('birth_date') is-invalid @enderror"
